...
def writeHtml(plots, tables, flagtable, dftable, outName, brainplot):#, wmlstable):#brainplot, wmlsplots, wmlstable):
    ...
    all_plot = '''<img src=''' + plots + '''></img>'''
    all_table =  '' + tables + ''
    all_brainplot =  '''<img src=''' + brainplot + ''' class="center" style="height:337px; width:792px;"></img>'''
    all_flag = '' + flagtable + ''
...
def _main(pdf_path, dfPat, tables, flagtable):
    ...
    print('../tmp/tmp_finalvis.png')
    
    #brainplot = _os.path.join(in_path_brainvis,UID+'_finalvis.png')
    brainplot = '../tmp/tmp_finalvis.png'
    plots = '../tmp/tmp_plot.png'
